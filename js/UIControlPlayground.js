...
$( "#toCanvas" ).click(function() {
    ...
    var PicMod;
    if($( "#PicMOD").is(":visible")){
        PicMod = $("#PicCur").val();
    }

    location.href = "./indexCanvas.html?Gate="+ModTarget+"&SkeMod="+SkeMod+"&SurMod="+SurMod+"&DynMod="+DynMod+"&FrameCount="+FrameCount+"&PapMod="+PapMod+"&PatMod="+PatMod+"&PicMod="+PicMod;
});
...
$( "#toGIF" ).click(function() {
    ...
    location.href = "./indexGIF.html?Gate="+ModTarget+"&SkeMod="+SkeMod+"&SurMod="+SurMod+"&DynMod="+DynMod+"&FrameCount="+FrameCount+"&PapMod="+PapMod+"&PatMod="+PatMod+"&PicMod="+PicMod;
});
