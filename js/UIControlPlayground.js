...
function iniciateCtrl(ModTarget){
    if(ModTarget == 0 || ModTarget == 1 || ModTarget == 7 || ModTarget == 8){
        $( "#FigureMOD").hide();
        $( "#SurfaceMOD").hide();
        $( "#DynamicMOD").hide();
        $( "#Frames").hide();
...
$( "#toCanvas" ).click(function() {
    var SkeMod;
    if($( "#FigureMOD").is(":visible")){
        SkeMod = $("#FigureCur").val();
    }
    var SurMod;
    if($( "#SurfaceMOD").is(":visible")){
        SurMod = $("#SurfaceCur").val();
    }
    var DynMod;
    if($( "#DynamicMOD").is(":visible")){
        DynMod = $("#DynamicCur").val();
    }
    var PapMod;
    if($( "#PaperMOD").is(":visible")){
        PapMod = $("#PaperCur").val();
    }
    var PatMod;
    if($( "#PatternMOD").is(":visible")){
        PatMod = $("#PatternCur").val();
    }
    var FrameCount;
    if($( "#Frames").is(":visible")){
        FrameCount = parseInt($("#FrameCountNum").val());
    }
    location.href = "./indexCanvas.html?Gate="+ModTarget+"&SkeMod="+SkeMod+"&SurMod="+SurMod+"&DynMod="+DynMod+"&FrameCount="+FrameCount+"&PapMod="+PapMod+"&PatMod="+PatMod;
});
...
$( "#toGIF" ).click(function() {
    ...
    location.href = "./indexGIF.html?Gate="+ModTarget+"&SkeMod="+SkeMod+"&SurMod="+SurMod+"&DynMod="+DynMod+"&FrameCount="+FrameCount+"&PapMod="+PapMod+"&PatMod="+PatMod;
});
